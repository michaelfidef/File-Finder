...
Public Class Form1
    ...
    Private Sub OpenAndSelectToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles OpenAndSelectToolStripMenuItem.Click
        If lvFile.SelectedItems.Count = 1 Then
            Process.Start("explorer.exe", "/select," & lvFile.SelectedItems(0).Tag)
        End If
    End Sub

    Private Sub CopyFullToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles CopyFullToolStripMenuItem.Click
        If lvFile.SelectedItems.Count = 1 Then
    ...
    Private Sub ExportFileToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles ExportFileToolStripMenuItem.Click
